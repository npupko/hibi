...
const BEHAVIORAL_PATTERNS: { re: RegExp; why: string }[] = [
  ...
  {
    re: /\bretr(y|ies|ied|ying)\b|backoff|exponential/i,
    why: "retry/backoff behavior",
  },
  {
    re: /\bO\([^)]+\)|complexity|linear time|constant time/i,
    why: "complexity claim",
  },
  { re: /\btimeout|timed? out|deadline\b/i, why: "timeout behavior" },
  {
    re: /\bidempotent|thread[- ]?safe|concurren|atomic\b/i,
    why: "concurrency/safety claim",
  },
