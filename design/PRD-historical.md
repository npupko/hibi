> Status: historical. This PRD describes the original design (2025). It is kept for reference and is not maintained. The current decisions are in `design/ADR-004-simplification.md`.
