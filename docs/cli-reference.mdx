...
description: "Complete reference for all hibi commands: record, check, diff, status, query, list, reanchor, retire, supersede, retract, archive, schema, and more."
icon: "terminal"
---
...
| `hibi list [--state …]` | Triage: one lean row per claim (handle, status, severity, recommended action), most-severe-first. |
...
you the exact command in their `remediation` menu, claim id pre-filled.
