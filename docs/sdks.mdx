---
title: "TypeScript and Rust SDKs for Building Hibi Resolvers"
sidebarTitle: "SDKs"
description: "The TypeScript and Rust SDKs handle JSONL-RPC framing for Hibi resolvers. Both bind to one shared JSON Schema source of truth from the Hibi data model."
icon: "cube"
---
