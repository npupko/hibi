...
If you want the protocol itself — the methods, the request/response shapes, the
default-deny manifest — start at [Resolvers](/resolvers). This page is about the
language bindings that sit on top of it.
