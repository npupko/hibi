...
description: "Hibi routes attention to behavioral claims when reachable evidence changes, then dispatches executable verifiers out-of-process with no model in the loop."
icon: "flask-vial"
---
...
reachable evidence changed. "Reachable evidence" is concrete and
...
the claim stays **unverified (resting)**. Rewording the *prose*
...
<Warning>
  ...
  of arbitrary code, and keeps your test harness, language, and runtime your own.
</Warning>
