---
title: "Why Hibi: Deterministic Doc-Staleness Detection Explained"
sidebarTitle: "Why Hibi"
description: "The problem Hibi solves, its threat model — a naive consumer reads the raw file and trusts it — and six principles that every design decision upholds."
icon: "compass"
---
